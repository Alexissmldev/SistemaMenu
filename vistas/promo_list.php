<div class="container mx-auto p-6 lg:p-10 max-w-7xl">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
        <div>
            ...
            <h2 class="text-sm text-gray-500 mt-2 ml-1">Gestiona las ofertas especiales (2x1, combos) para el carrusel.</h2>
        </div>

        <div>
            <a href="index.php?vista=promo_new" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-bold text-white bg-orange-600 rounded-lg hover:bg-orange-700 shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                <div class="md:col-span-9 lg:col-span-10">
                    <div class="relative">
                        ...
                        <input type="text" name="txt_buscador" class="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-orange-500 focus:border-orange-500 transition-colors" placeholder="Buscar por nombre de la promoción..." value="<?php echo isset($_GET['busqueda']) ? htmlspecialchars($_GET['busqueda']) : ''; ?>">
                    </div>
                </div>
                ...
                <div class="md:col-span-3 lg:col-span-2 flex gap-2">
                    ...
                    <?php if (isset($_GET['busqueda']) && !empty($_GET['busqueda'])): ?>
                        <a href="index.php?vista=promo_list" class="flex items-center justify-center px-4 py-3 text-gray-500 bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-lg transition-colors" title="Limpiar Búsqueda">
